...
import 'package:original_taste/controller/ui/components/chart_controller.dart';
  ...
  Widget _buildDashedStepLineChart() {
    return MyCard(
      ...
      child: SfCartesianChart(
        ...
        primaryXAxis: NumericAxis(interval: 1, majorGridLines: MajorGridLines(width: 0), title: AxisTitle(text: 'Year')),
