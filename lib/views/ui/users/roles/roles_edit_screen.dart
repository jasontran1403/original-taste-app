...
import 'package:original_taste/controller/ui/users/roles/roles_edit_controller.dart';
...
class RolesEditScreen extends StatefulWidget {
  const RolesEditScreen({super.key});

  @override
  State<RolesEditScreen> createState() => _RolesEditScreenState();
}

class _RolesEditScreenState extends State<RolesEditScreen> with UIMixin {
  RolesEditController controller = Get.put(RolesEditController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RolesEditController>(
      init: controller,
