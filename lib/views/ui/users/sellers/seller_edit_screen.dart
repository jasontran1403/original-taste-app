...
import 'package:original_taste/controller/ui/users/sellers/seller_edit_controller.dart';
...
class _SellerEditScreenState extends State<SellerEditScreen> with UIMixin {
  SellerEditController controller = Get.put(SellerEditController());
