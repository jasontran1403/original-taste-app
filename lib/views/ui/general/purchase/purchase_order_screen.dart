...
import 'package:original_taste/controller/ui/general/purchase/purchase_order_controller.dart';
...
class _PurchaseOrderScreenState extends State<PurchaseOrderScreen> with UIMixin {
  PurchaseOrderController controller = Get.put(PurchaseOrderController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: controller,
      tag: 'purchase_order_controller',
      builder: (controller) {
        return Layout(
          ...
          child: MyFlex(
            children: [
              MyFlexItem(
                sizes: 'lg-3',
                child: stats("Pending Review", "210", "assets/svg/clipboard_remove_broken.svg", "6.9", Boxicons.bx_down_arrow_alt),
              ),
              MyFlexItem(sizes: 'lg-3', child: stats("Pending Payment", "608", "assets/svg/sort_by_time.svg", "13.2", Boxicons.bx_up_arrow_alt)),
              MyFlexItem(sizes: 'lg-3', child: stats("Delivered", "200", "assets/svg/bag_cross_broken.svg", "2.1", Boxicons.bx_up_arrow_alt)),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    MySpacing.width(8),
                    MyText.bodySmall("(Last Week)", muted: true),
                  ],
                ),
              ],
            ),
    ...
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(height: 0),
          if (controller.purchaseOrder.isEmpty)
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: [
                  ...
                  DataColumn(label: MyText.labelLarge('Email', fontWeight: 700)),
                ...
                rows: List.generate(controller.purchaseOrder.length, (index) {
                  final data = controller.purchaseOrder[index];
                  return DataRow(
                    cells: [
                      ...
                      DataCell(MyText.bodySmall(data.total, fontWeight: 600)),
