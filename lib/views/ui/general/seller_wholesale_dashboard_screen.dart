...
class SellerWholesaleDashboardScreen extends StatefulWidget {
  ...
  @override
  State<SellerWholesaleDashboardScreen> createState() =>
      _SellerWholesaleDashboardScreenState();
}

class _SellerWholesaleDashboardScreenState
    extends State<SellerWholesaleDashboardScreen>
    with UIMixin {
  // State cho bản đồ
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        key: const PageStorageKey<String>('wholesale_dashboard_scroll'),  // unique key
        controller: _scrollCtrl,
        physics: const AlwaysScrollableScrollPhysics(),
        padding: const EdgeInsets.all(16),
        child: Column(
          children: [
            _buildCards(widget.data),
            const SizedBox(height: 14),
            IntrinsicHeight(
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Expanded(flex: 3, child: _buildChart(widget.data)),
                  const SizedBox(width: 12),
                  Expanded(flex: 2, child: _buildPaymentPie(widget.data)),
                ],
              ),
            ),
            const SizedBox(height: 14),
            IntrinsicHeight(
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Expanded(flex: 3, child: _buildRegionChart(widget.data)),
                  const SizedBox(width: 12),
                  Expanded(flex: 2, child: _buildTopProducts(widget.data)),
                ],
              ),
            ),
            const SizedBox(height: 14),
            IntrinsicHeight(
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Expanded(child: _buildTopUsers(widget.data)),
                  const SizedBox(width: 12),
                  Expanded(child: _buildTopCustomers(widget.data)),
                ],
              ),
            ),
            const SizedBox(height: 14),
            _buildRecentOrders(widget.data),
      ...
      children: [
        Expanded(
          child: _StatCard(
            ...
            color: _ct.primary,
            title: 'Đơn hàng',
            value: d.orderSummary.totalOrders,
            isCurrency: false,
        ...
        Expanded(
          child: _StatCard(
            ...
            color: Colors.green,
            title: 'Doanh thu',
            value: d.revenueSummary.completedRevenue,
            isCurrency: true,
        ...
        Expanded(
          child: _StatCard(
            ...
            color: Colors.orange,
            title: 'Thống kê',
            value: d.revenueSummary.pendingRevenue,
            isCurrency: true,
  ...
  Widget _buildRegionChart(RestaurantDashboardModel d) {
    ...
    final markers =
        regions.where((r) => _provinceCoords.containsKey(r.region)).toList();
    ...
    return MyCard(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [_sectionTitle('Đơn hàng theo vị trí'), const Spacer()],
          ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 1,
            child: Text('Trạng thái', style: s, textAlign: TextAlign.center),
          ),
        ],
      ),
    );
...
class _RegionDotState extends State<_RegionDot>
