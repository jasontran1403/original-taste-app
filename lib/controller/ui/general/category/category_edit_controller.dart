...
class CategoryEditController extends MyController {
  ...
  @override
  void onInit() {
    categoryTitleController = TextEditingController(text: 'Fashion Men , Women & Kid\'s');
    stockController = TextEditingController(text: '46233');
    tagIdController = TextEditingController(text: 'FS16276');
    ...
    metaTitleController = TextEditingController(text: 'Fashion Brand');
    metaDescriptionController = TextEditingController(text: '');
    metaTagController = TextEditingController(text: 'fashion');
    super.onInit();
  }

  final List<String> categories = ['Admin', 'Other', 'Seller'];
